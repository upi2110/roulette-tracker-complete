/**
 * AI Prediction Panel - FIXED ORDER
 * Panel order: This creates SECOND (MIDDLE position)
 */
...
class AIPredictionPanel {
    constructor() {
        ...
        console.log('✅ AI Prediction Panel initialized (MIDDLE position)');
    }
            ...
            <div class="panel-content" id="aiPanelContent" style="display: block;">
                <div class="prediction-status">
                    ...
                    <div class="confidence-display" style="text-align: center;">
                        ...
                        <div style="font-size: 32px; font-weight: bold; color: #3b82f6;">0%</div>
                    </div>
                </div>
                ...
                <div class="prediction-numbers" style="margin-top: 16px;">
                    <div style="color: #9ca3af; font-style: italic; padding: 20px; text-align: center;">
                        🎯 Enter at least 3 spins to begin
                    </div>
                </div>
                ...
                <div class="prediction-reasoning" style="margin-top: 16px; padding: 12px; background: #f8fafc; border-radius: 8px; font-size: 12px; color: #475569;">
                    <strong style="color: #1e293b;">AI REASONING:</strong>
                    <ul style="margin: 10px 0 0 0; padding-left: 22px;">
                        <li>Enter at least 3 spins to start predictions</li>
                        <li>The AI learns patterns from your spin history</li>
                        <li>More spins = better accuracy</li>
                    </ul>
                </div>
            </div>
        `;

        // INSERT SECOND (after wheel, before money)
        container.appendChild(panel);
        console.log('✅ AI Prediction panel created (MIDDLE position)');
    }
    ...
    updatePrediction(prediction) {
        ...
        // Get anchors and loose from backend (DON'T recalculate)
        ...
        // 2. UPDATE CONFIDENCE
        const confidenceDiv = panel.querySelector('.confidence-display');
        if (confidenceDiv) {
                ...
                <div style="margin-bottom: 12px;">
                    ...
                    <div style="margin-bottom: 14px; padding: 12px; background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius: 10px; border: 2px solid #f59e0b;">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 7px;">
                            ...
                            `).join('') : '<span style="color: #92400e; font-style: italic;">None - no numbers with both neighbors</span>'}
                        </div>
                    </div>
        ...
        if (reasoningDiv && prediction.reasoning) {
            ...
            reasoningDiv.innerHTML = `
                <div style="font-size: 12px; line-height: 1.7; color: #475569;">
                    <strong style="color: #1e293b; font-size: 13px;">AI REASONING:</strong>
                    <ul style="margin: 10px 0 0 0; padding-left: 22px; list-style: none;">
                        ...
                        ${r.filtering_applied ? '<li>• ✅ Filtered using Table 1 & 2</li>' : '<li>• No filtering applied</li>'}
                    </ul>
                </div>
            `;
        }
        
        // 5. UPDATE WHEEL HIGHLIGHTS
...
document.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => {
        ...
        console.log('✅ AI Prediction Panel ready (MIDDLE position)');
    }, 150); // Slight delay to ensure wheel loads first
});

console.log('✅ AI Prediction Panel script loaded');
